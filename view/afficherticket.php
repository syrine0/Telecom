...
session_start();
    ...
    $ticketc=new ticketc();
    $listeticket =$ticketc->afficherticket();
...
<nav>
    ...
    <div class="card-body"  > 
             ...
             <center><p class="registre-card-description">Ajouter une Ticket</p></center>
                    ...
                    <table class="table table-striped">
                      <thead>
                        <tr>
                          ...
                          <th scope="col-10">OFFRE</th>
                          <th scope="col-10">ACTION</th>
                        </tr>
                      </thead>
                      <?php foreach($listeticket as $ticket) { ?>
                        <form action ="supprimerticket.php" method="POST">

                      <tbody>
                        <tr>
                          <td><?php echo  $ticket['ticket_id'] ;?></td>
                          <td><?php echo  $ticket['ticket_matricule'] ;?></td>
                          <td><?php echo  $ticket['ticket_nompre'] ;?></td>
                          <td><?php echo  $ticket['ticket_nbper'] ;?></td>
                          <td><?php echo  $ticket['type_ticket'] ;?></td>
                          <td><?php echo  $ticket['offre_ticket'] ;?></td>
                          <td>   
                          <input id="supprimer" data-id="<?php echo $ticket['ticket_id']; ?>" type="button" class="btn btn-danger" value="supprimer" />
                          <a href="modifierticket.php?modifier=<?php echo $ticket['ticket_id']; ?>" type="button" class="btn btn-primary" value="modifier" title="modifier" >MODIFIER</a>              
