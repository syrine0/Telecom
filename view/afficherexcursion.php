...
session_start();
    ...
    $listeexcursion =$excursionc->afficherexcursion();
...
<nav>
    ...
    <div class="card-body"  > 
             ...
             <center><p class="registre-card-description">Afficher Excursions</p></center>
                    ...
                    <table class="table table-striped">
                      <thead>
                        <tr>
                          ...
                          <th scope="col-10">AGE</th>
                          <th scope="col">TYPE</th>
                          <th></th>
                          <th scope="col-10">ACTION</th>
                        </tr>
                      </thead>
                      <?php foreach($listeexcursion as $excursion) { ?>
                        <form action ="supprimerexcursion.php" method="POST">

                      <tbody>
                        <tr>
                          <td><?php echo  $excursion['excursion_id'] ;?></td>
                          <td><?php echo  $excursion['excursion_matricule'] ;?></td>
                          <td><?php echo  $excursion['excursion_nompre'] ;?></td>
                          <td><?php echo  $excursion['excursion_age'] ;?></td>
                       
                          <td><?php echo  $excursion['type_excursion'] ;?></td>
                          <td></td>
                          <td>   
                          <input id="supprimer" data-id="<?php echo $excursion['excursion_id']; ?>" type="button" class="btn btn-danger" value="supprimer" />
                          <a href="modifierexcursion.php?modifier=<?php echo $excursion['excursion_id']; ?>" type="button" class="btn btn-primary" value="modifier" title="modifier" >MODIFIER</a>              
                        </form>
                          </td>
                        </tr>
                      </tbody>
