...
session_start();
    ...
    $sportc=new sportc();
    $listesport =$sportc->affichersport();
...
<nav>
    ...
    <div class="card-body"  > 
             ...
             <center><p class="registre-card-description">Afficher Sports</p></center>
                    ...
                    <table class="table table-striped">
                      ...
                      <?php foreach($listesport as $sport) { ?>
                        <form action ="supprimersport.php" method="POST">

                      <tbody>
                        <tr>
                          <td><?php echo  $sport['sport_id'] ;?></td>
                          <td><?php echo  $sport['sport_matricule'] ;?></td>
                          <td><?php echo  $sport['sport_nompre'] ;?></td>
                          <td><?php echo  $sport['type_sport'] ;?></td>
                          <td><?php echo  $sport['sport_age'] ;?></td>
                          <td></td>
                          <td>   
                          <input id="supprimer" data-id="<?php echo $sport['sport_id']; ?>" type="button" class="btn btn-danger" value="supprimer" />
                          <a href="modifiersport.php?modifier=<?php echo $sport['sport_id']; ?>" type="button" class="btn btn-primary" value="modifier" title="modifier" >MODIFIER</a>              
